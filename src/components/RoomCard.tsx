  ...
  return <div className={cn("bg-white rounded-xl overflow-hidden shadow-md transition-all duration-500 animate-slide-up card-hover")} style={{
    animationDelay: `${delay}ms`
      ...
      <div className="p-6 bg-slate-300">
        ...
        <Link to="/booking" className="block w-full py-3 text-center bg-accent text-accent-foreground rounded-md transition-all duration-300 hover:bg-accent/90">Book Now
        </Link>
      </div>
    </div>;
 };
